    ...
    <div class="content">
        <div class="settled-in-search">
            <el-form :inline="true" ref="form" :model="form" label-width="80px">
                ...
                <el-form-item label="申请时间" prop="value3" label-width="80px">
                    <el-date-picker
                            v-model="form.value3"
                            type="datetimerange"
                ...
                <el-form-item label="持证人" prop="hold_seller_id">
                    <el-input v-model="form.hold_seller_id" placeholder="请输入"></el-input>
                </el-form-item>
                <el-form-item label="证书编码" prop="certificate_code">
                    <el-input v-model="form.certificate_code" placeholder="请输入"></el-input>
                </el-form-item>
        ...
        <div class="table-content">
            <el-table
                ...
                <el-table-column prop="shop_name" label="店铺名称" width="150px" show-overflow-tooltip></el-table-column>
                <el-table-column prop="hold_seller_id" label="持证人/证书编码" width="230px" show-overflow-tooltip>
                    <template slot-scope="scope" v-if="scope.row.certificate_code">
                       {{scope.row.hold_seller_id}} / {{scope.row.certificate_code}}
                    </template>
                </el-table-column>
                <el-table-column prop="member_name" label="证书" show-overflow-tooltip>
                ...
                <el-table-column prop="fail_message" label="审核原因" width="120px;" show-overflow-tooltip></el-table-column>
                <el-table-column prop="reviewer" label="审核人" width="120px;" show-overflow-tooltip></el-table-column>
    ...
    export default {
        ...
        methods: {
            async dataList () {
                ...
                param['hold_seller_id'] = this.form.hold_seller_id;
                param['certificate_code'] = this.form.certificate_code;
            ...
            async checkStore(data){
                this.$confirm('是否设置为审核通过', '提示', {
                    ...
                    let result = await this.$request.request(this.$API.common_api,{
                        ...
                        request_host:'SHOP_CERTIFICATION_HOST',
                        handle_desc:"专业培训信息审核通过;"+data.shop_id,
                    });
            ...
            async checkCentent(data){
                this.$prompt('请输入审核原因', '提示', {
                    ...
                    let result = await this.$request.request(this.$API.common_api,{
                        ...
                        router_path: 'opp/train_info',
                        request_host:'SHOP_CERTIFICATION_HOST',
                        handle_desc:"专业培训信息审核不通过;"+data.shop_id,
                    });
                    SendMessage({message: '审核成功', type: 'success'});
                    this.dataList();
                }).catch(() => {
            ...
            onClear(form){
                ...
                this.form.name = '';
                this.form.value3 = '';
                this.form.certificate_code = '';
                this.form.hold_seller_id = '';
            },
