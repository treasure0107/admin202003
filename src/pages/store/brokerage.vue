...
<!--        </div>-->
        <div class="form-search">
            <el-form ref="formInline" :inline="true" :model="formInline" class="demo-form-inline">
                <el-form-item label="店铺名称" prop="self_shop_name">
                    <el-input v-model="formInline.self_shop_name" placeholder="店铺名称" size="mini"></el-input>
                </el-form-item>
        ...
        <div class="table-content">
                    ...
                    <el-table ref="all" :data="tableData.data" height="750" border style="width: 100%" v-loading="loading" @selection-change="handleSelectionChange">
                        ...
                        <el-table-column prop="self_shop_name" label="店铺名称"></el-table-column>
        ...
        methods: {
            ...
            exportOrder(){
                ...
                if(this.id_list.length){
                    window.location.href = this.ppy_host+'/api/application_seller/se_wallet/manage_settlement?distribution_shop=0&id_list=[' + this.id_list.join(',') + ']'
                }else{
                    let param = '&self_shop_name='+data.self_shop_name+'&distribution_shop=0&order_sn='+data.order_sn+'&start_time='+data.start_time+'&end_time='+data.end_time+'&pay_type='+data.pay_type+'&pay_status='+data.pay_status
