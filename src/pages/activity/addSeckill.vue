<template>
  <div class="content">
    <div class="pages-header">
      <div><router-link to="/activity/seckill" style="text-decoration:none;color:#000000;">秒杀管理</router-link>/创建秒杀</div>
    </div>
    <div class="content-cont table-content">
      <div class="pages-inline">
        ...
        <el-form ref="form" :model="form" :rules="rules1" label-width="120px">
          <el-form-item label="秒杀时间" prop="time" required>
            <el-date-picker
              v-model="form.time"
              type="datetimerange"
        ...
        <div class="pages-inline">
          ...
          <el-form-item  v-if="addForm.goods_name == ''" label="添加商品">
            <el-button type="primary" round icon="el-icon-plus" size="medium" @click="showAdd=true">添加商品</el-button>
          </el-form-item>
          ...
          <el-form-item>
            <el-button type="primary" @click="submit_form_add('form',2)">保存</el-button>
            <el-button type="primary" @click="submit_form_add('form',1)">创建</el-button>
          </el-form-item>
        </el-form>
    </div>
    <el-dialog title="添加商品" :visible.sync="showAdd"   width="70%">
      <el-form  :model="addForm" ref="addForm" class="demo-form-inline">
        ...
        <el-form-item>
          <el-table :data="skuArrList" stripe height="280" border style="width: 100%" @selection-change="handleSelectionChange">
            ...
            <el-table-column label="秒杀价格" width="220px" required>
                <template slot-scope="scope" >
                  <el-form-item  prop="activity_price" >
                    <el-col :span="14">
                     <el-input v-model="addForm.activity_price[scope.$index]" placeholder="请输入秒杀价格"></el-input>
                    </el-col>
                    <el-button  type="text"  size="mini"  @click="setAllPrince(scope.$index)">设置全部</el-button>
                  </el-form-item>
                </template>
            </el-table-column>
            <el-table-column  label="平台补贴比例"  width="240px">
                <template slot-scope="scope" >
                  <el-form-item  prop="subsidy_precent">
  ...
  export default {
    ...
    methods: {
      ...
      add_attr_arr_all(){
         this.skuArrList=[]
      /*  let arr = [
          [{attr_name:"材质",attr_value:'200通知',attr_id:"5",price:1,attr_value_id:"100"},{attr_value_id:"100",attr_name:"材质",attr_value:'300通知',attr_id:"6",price:2}],
          [{attr_name:"厚度",attr_value:'10mm',attr_id:"7",price:3,attr_value_id:"101"},{attr_value_id:"100",attr_name:"厚度",attr_value:'20mm',attr_id:"8",price:4}],
      ...
      submit_form_add(ruleForm,status){
        this.$refs[ruleForm].validate(async (valid) => {
          if (valid) {
            ...
            let res = await this.$request.post(this.$API.add_seckill, this.form,'',{handle_desc:'新增秒杀;'});
            if(res.code==200){
              SendMessage({
                message: '操作成功',
                type:'success'
