<template>
  <div class="content">
    <div class="pages-header">
      <div><router-link to="/activity/tg" style="text-decoration:none;color:#000000;">团购管理</router-link>/团购详情</div>
    </div>
    <div class="content-cont table-content">
      ...
      <el-form ref="form" :model="form"  label-width="120px">
        <el-form-item label="团购时间" prop="time">
