<template>
  <div class="template-floor">
    ...
    <div class="images-list">
      <div class="list-1">
        <div class="list-1-1" @click="nowIndex='1-1'" @mouseenter="nowIndex='1-1'" :class="{'activity':nowIndex=='1-1'}">
        ...
        <div class="list-1-2" @click="nowIndex='1-2'" @mouseenter="nowIndex='1-2'" :class="{'activity':nowIndex=='1-2'}">
          <img :src="list['1-2'].img_url" alt="" v-if="list['1-2'].img_url">
          <template v-else>1-2</template>
          <div class="activity-pop" v-if="nowIndex=='1-2'" @click="setOpenUpload">编辑</div>
        </div>
      </div>

      <div class="list-2">
        <div class="list-2-1" @click="nowIndex='2-1'" @mouseenter="nowIndex='2-1'" :class="{'activity':nowIndex=='2-1'}">
    ...
    <el-dialog title="编辑广告位" :visible.sync="openUpload" width="50%" append-to-body>
      <el-form :model="images" ref="formsss" label-width="120px">
        <el-form-item label="广告图片" prop="img_url" :maxsize="300*1024"
